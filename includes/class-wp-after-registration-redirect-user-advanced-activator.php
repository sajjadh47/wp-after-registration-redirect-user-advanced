<?php
/**
 * This file contains the definition of the Wp_After_Registration_Redirect_User_Advanced_Activator class, which
 ...
 * @since    2.0.0
 */
class Wp_After_Registration_Redirect_User_Advanced_Activator {
	/**
	 * Activation hook.
	 *
